...
var file_recordcollection_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x03, 0x52, 0x08, 0x6c, 0x61, 0x73, 0x74, 0x48, 0x61, 0x76, 0x65, 0x22, 0xd9, 0x04,
...
var file_recordcollection_proto_msgTypes = make([]protoimpl.MessageInfo, 42)
var file_recordcollection_proto_goTypes = []interface{}{
	...
	(*ClientUpdateRequest)(nil),         // 36: recordcollection.ClientUpdateRequest
	(*ClientUpdateResponse)(nil),        // 37: recordcollection.ClientUpdateResponse
	nil,                                 // 38: recordcollection.RecordCollection.InstanceToFolderEntry
	nil,                                 // 39: recordcollection.RecordCollection.InstanceToUpdateEntry
	nil,                                 // 40: recordcollection.RecordCollection.InstanceToUpdateInEntry
	nil,                                 // 41: recordcollection.RecordCollection.InstanceToCategoryEntry
	nil,                                 // 42: recordcollection.RecordCollection.InstanceToMasterEntry
	nil,                                 // 43: recordcollection.RecordCollection.InstanceToIdEntry
	nil,                                 // 44: recordcollection.RecordCollection.InstanceToRecacheEntry
	nil,                                 // 45: recordcollection.RecordCollection.InstanceToLastSalePriceUpdateEntry
	(*godiscogs.Release)(nil),           // 46: godiscogs.Release
	(godiscogs.SaleState)(0),            // 47: godiscogs.SaleState
}
var file_recordcollection_proto_depIdxs = []int32{
	...
	46, // 3: recordcollection.RecordCollection.wants:type_name -> godiscogs.Release
	10, // 4: recordcollection.RecordCollection.new_wants:type_name -> recordcollection.Want
	38, // 5: recordcollection.RecordCollection.instance_to_folder:type_name -> recordcollection.RecordCollection.InstanceToFolderEntry
	39, // 6: recordcollection.RecordCollection.instance_to_update:type_name -> recordcollection.RecordCollection.InstanceToUpdateEntry
	40, // 7: recordcollection.RecordCollection.instance_to_update_in:type_name -> recordcollection.RecordCollection.InstanceToUpdateInEntry
	41, // 8: recordcollection.RecordCollection.instance_to_category:type_name -> recordcollection.RecordCollection.InstanceToCategoryEntry
	42, // 9: recordcollection.RecordCollection.instance_to_master:type_name -> recordcollection.RecordCollection.InstanceToMasterEntry
	43, // 10: recordcollection.RecordCollection.instance_to_id:type_name -> recordcollection.RecordCollection.InstanceToIdEntry
	44, // 11: recordcollection.RecordCollection.instance_to_recache:type_name -> recordcollection.RecordCollection.InstanceToRecacheEntry
	45, // 12: recordcollection.RecordCollection.instance_to_last_sale_price_update:type_name -> recordcollection.RecordCollection.InstanceToLastSalePriceUpdateEntry
	9,  // 13: recordcollection.AllRecords.records:type_name -> recordcollection.Record
	46, // 14: recordcollection.Record.release:type_name -> godiscogs.Release
	13, // 15: recordcollection.Record.metadata:type_name -> recordcollection.ReleaseMetadata
	46, // 16: recordcollection.Want.release:type_name -> godiscogs.Release
	...
	47, // 20: recordcollection.ReleaseMetadata.sale_state:type_name -> godiscogs.SaleState
	...
	16, // 37: recordcollection.RecordCollectionService.GetWants:input_type -> recordcollection.GetWantsRequest
	18, // 38: recordcollection.RecordCollectionService.UpdateRecord:input_type -> recordcollection.UpdateRecordRequest
	20, // 39: recordcollection.RecordCollectionService.UpdateWant:input_type -> recordcollection.UpdateWantRequest
	22, // 40: recordcollection.RecordCollectionService.AddRecord:input_type -> recordcollection.AddRecordRequest
	26, // 41: recordcollection.RecordCollectionService.DeleteRecord:input_type -> recordcollection.DeleteRecordRequest
	28, // 42: recordcollection.RecordCollectionService.QueryRecords:input_type -> recordcollection.QueryRecordsRequest
	30, // 43: recordcollection.RecordCollectionService.GetRecord:input_type -> recordcollection.GetRecordRequest
	32, // 44: recordcollection.RecordCollectionService.Trigger:input_type -> recordcollection.TriggerRequest
	34, // 45: recordcollection.RecordCollectionService.GetUpdates:input_type -> recordcollection.GetUpdatesRequest
	36, // 46: recordcollection.ClientUpdateService.ClientUpdate:input_type -> recordcollection.ClientUpdateRequest
	17, // 47: recordcollection.RecordCollectionService.GetWants:output_type -> recordcollection.GetWantsResponse
	19, // 48: recordcollection.RecordCollectionService.UpdateRecord:output_type -> recordcollection.UpdateRecordsResponse
	21, // 49: recordcollection.RecordCollectionService.UpdateWant:output_type -> recordcollection.UpdateWantResponse
	23, // 50: recordcollection.RecordCollectionService.AddRecord:output_type -> recordcollection.AddRecordResponse
	27, // 51: recordcollection.RecordCollectionService.DeleteRecord:output_type -> recordcollection.DeleteRecordResponse
	29, // 52: recordcollection.RecordCollectionService.QueryRecords:output_type -> recordcollection.QueryRecordsResponse
	31, // 53: recordcollection.RecordCollectionService.GetRecord:output_type -> recordcollection.GetRecordResponse
	33, // 54: recordcollection.RecordCollectionService.Trigger:output_type -> recordcollection.TriggerResponse
	35, // 55: recordcollection.RecordCollectionService.GetUpdates:output_type -> recordcollection.GetUpdatesResponse
	37, // 56: recordcollection.ClientUpdateService.ClientUpdate:output_type -> recordcollection.ClientUpdateResponse
