...
var file_recordcollection_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0xc7, 0x1a, 0x0a, 0x0f, 0x52, 0x65,
	...
	0x73, 0x74, 0x41, 0x75, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x90, 0x05, 0x0a, 0x08, 0x43,
	...
	0x4c, 0x4c, 0x5f, 0x4d, 0x41, 0x54, 0x43, 0x48, 0x10, 0x03, 0x22, 0x93, 0x01, 0x0a, 0x08, 0x42,
	...
	,
	...
	0x01, 0x20, 0x01, 0x28, 0x02, 0x52, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x22, 0x35, 0x0a, 0x13,
	...
	0xd5, 0x08, 0x0a, 0x17, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63,
...
var file_recordcollection_proto_goTypes = []interface{}{
	...
	(*CommitRecordRequest)(nil),         // 39: recordcollection.CommitRecordRequest
	(*CommitRecordResponse)(nil),        // 40: recordcollection.CommitRecordResponse
	(*GetPriceRequest)(nil),             // 41: recordcollection.GetPriceRequest
	(*GetPriceResponse)(nil),            // 42: recordcollection.GetPriceResponse
	(*ClientUpdateRequest)(nil),         // 43: recordcollection.ClientUpdateRequest
	(*ClientUpdateResponse)(nil),        // 44: recordcollection.ClientUpdateResponse
	nil,                                 // 45: recordcollection.RecordCollection.InstanceToFolderEntry
	nil,                                 // 46: recordcollection.RecordCollection.InstanceToUpdateEntry
	nil,                                 // 47: recordcollection.RecordCollection.InstanceToUpdateInEntry
	nil,                                 // 48: recordcollection.RecordCollection.InstanceToCategoryEntry
	nil,                                 // 49: recordcollection.RecordCollection.InstanceToMasterEntry
	nil,                                 // 50: recordcollection.RecordCollection.InstanceToIdEntry
	nil,                                 // 51: recordcollection.RecordCollection.InstanceToRecacheEntry
	nil,                                 // 52: recordcollection.RecordCollection.InstanceToLastSalePriceUpdateEntry
	nil,                                 // 53: recordcollection.GetOrderResponse.ListingToPriceEntry
	(*godiscogs.Release)(nil),           // 54: godiscogs.Release
	(godiscogs.SaleState)(0),            // 55: godiscogs.SaleState
}
var file_recordcollection_proto_depIdxs = []int32{
	...
	54, // 3: recordcollection.RecordCollection.wants:type_name -> godiscogs.Release
	12, // 4: recordcollection.RecordCollection.new_wants:type_name -> recordcollection.Want
	45, // 5: recordcollection.RecordCollection.instance_to_folder:type_name -> recordcollection.RecordCollection.InstanceToFolderEntry
	46, // 6: recordcollection.RecordCollection.instance_to_update:type_name -> recordcollection.RecordCollection.InstanceToUpdateEntry
	47, // 7: recordcollection.RecordCollection.instance_to_update_in:type_name -> recordcollection.RecordCollection.InstanceToUpdateInEntry
	48, // 8: recordcollection.RecordCollection.instance_to_category:type_name -> recordcollection.RecordCollection.InstanceToCategoryEntry
	49, // 9: recordcollection.RecordCollection.instance_to_master:type_name -> recordcollection.RecordCollection.InstanceToMasterEntry
	50, // 10: recordcollection.RecordCollection.instance_to_id:type_name -> recordcollection.RecordCollection.InstanceToIdEntry
	51, // 11: recordcollection.RecordCollection.instance_to_recache:type_name -> recordcollection.RecordCollection.InstanceToRecacheEntry
	52, // 12: recordcollection.RecordCollection.instance_to_last_sale_price_update:type_name -> recordcollection.RecordCollection.InstanceToLastSalePriceUpdateEntry
	11, // 13: recordcollection.AllRecords.records:type_name -> recordcollection.Record
	54, // 14: recordcollection.Record.release:type_name -> godiscogs.Release
	...
	55, // 18: recordcollection.ReleaseMetadata.sale_state:type_name -> godiscogs.SaleState
	...
	11, // 24: recordcollection.GetRecordsRequest.filter:type_name -> recordcollection.Record
	11, // 25: recordcollection.GetRecordsResponse.records:type_name -> recordcollection.Record
	12, // 26: recordcollection.GetWantsRequest.filter:type_name -> recordcollection.Want
	12, // 27: recordcollection.GetWantsResponse.wants:type_name -> recordcollection.Want
	11, // 28: recordcollection.UpdateRecordRequest.update:type_name -> recordcollection.Record
	11, // 29: recordcollection.UpdateRecordsResponse.updated:type_name -> recordcollection.Record
	12, // 30: recordcollection.UpdateWantRequest.update:type_name -> recordcollection.Want
	12, // 31: recordcollection.UpdateWantResponse.updated:type_name -> recordcollection.Want
	11, // 32: recordcollection.AddRecordRequest.to_add:type_name -> recordcollection.Record
	11, // 33: recordcollection.AddRecordResponse.added:type_name -> recordcollection.Record
	1,  // 34: recordcollection.QueryRecordsRequest.category:type_name -> recordcollection.ReleaseMetadata.Category
	11, // 35: recordcollection.GetRecordResponse.record:type_name -> recordcollection.Record
	7,  // 36: recordcollection.GetUpdatesResponse.updates:type_name -> recordcollection.Updates
	53, // 37: recordcollection.GetOrderResponse.listing_to_price:type_name -> recordcollection.GetOrderResponse.ListingToPriceEntry
	1,  // 38: recordcollection.RecordCollection.InstanceToCategoryEntry.value:type_name -> recordcollection.ReleaseMetadata.Category
	17, // 39: recordcollection.RecordCollectionService.GetWants:input_type -> recordcollection.GetWantsRequest
	19, // 40: recordcollection.RecordCollectionService.UpdateRecord:input_type -> recordcollection.UpdateRecordRequest
	21, // 41: recordcollection.RecordCollectionService.UpdateWant:input_type -> recordcollection.UpdateWantRequest
	23, // 42: recordcollection.RecordCollectionService.AddRecord:input_type -> recordcollection.AddRecordRequest
	27, // 43: recordcollection.RecordCollectionService.DeleteRecord:input_type -> recordcollection.DeleteRecordRequest
	29, // 44: recordcollection.RecordCollectionService.QueryRecords:input_type -> recordcollection.QueryRecordsRequest
	31, // 45: recordcollection.RecordCollectionService.GetRecord:input_type -> recordcollection.GetRecordRequest
	33, // 46: recordcollection.RecordCollectionService.Trigger:input_type -> recordcollection.TriggerRequest
	35, // 47: recordcollection.RecordCollectionService.GetUpdates:input_type -> recordcollection.GetUpdatesRequest
	37, // 48: recordcollection.RecordCollectionService.GetOrder:input_type -> recordcollection.GetOrderRequest
	39, // 49: recordcollection.RecordCollectionService.CommitRecord:input_type -> recordcollection.CommitRecordRequest
	41, // 50: recordcollection.RecordCollectionService.GetPrice:input_type -> recordcollection.GetPriceRequest
	43, // 51: recordcollection.ClientUpdateService.ClientUpdate:input_type -> recordcollection.ClientUpdateRequest
	18, // 52: recordcollection.RecordCollectionService.GetWants:output_type -> recordcollection.GetWantsResponse
	20, // 53: recordcollection.RecordCollectionService.UpdateRecord:output_type -> recordcollection.UpdateRecordsResponse
	22, // 54: recordcollection.RecordCollectionService.UpdateWant:output_type -> recordcollection.UpdateWantResponse
	24, // 55: recordcollection.RecordCollectionService.AddRecord:output_type -> recordcollection.AddRecordResponse
	28, // 56: recordcollection.RecordCollectionService.DeleteRecord:output_type -> recordcollection.DeleteRecordResponse
	30, // 57: recordcollection.RecordCollectionService.QueryRecords:output_type -> recordcollection.QueryRecordsResponse
	32, // 58: recordcollection.RecordCollectionService.GetRecord:output_type -> recordcollection.GetRecordResponse
	34, // 59: recordcollection.RecordCollectionService.Trigger:output_type -> recordcollection.TriggerResponse
	36, // 60: recordcollection.RecordCollectionService.GetUpdates:output_type -> recordcollection.GetUpdatesResponse
	38, // 61: recordcollection.RecordCollectionService.GetOrder:output_type -> recordcollection.GetOrderResponse
	40, // 62: recordcollection.RecordCollectionService.CommitRecord:output_type -> recordcollection.CommitRecordResponse
	42, // 63: recordcollection.RecordCollectionService.GetPrice:output_type -> recordcollection.GetPriceResponse
	44, // 64: recordcollection.ClientUpdateService.ClientUpdate:output_type -> recordcollection.ClientUpdateResponse
