...
type ReleaseMetadata struct {
	...
	OverallScore float32 `protobuf:"fixed32,16,opt,name=overall_score,json=overallScore" json:"overall_score,omitempty"`
	// Width of spine in mm
	SpineWidth int32 `protobuf:"varint,17,opt,name=spine_width,json=spineWidth" json:"spine_width,omitempty"`
	// Sale cost and ID if applicable
	SaleCost int32 `protobuf:"varint,18,opt,name=sale_cost,json=saleCost" json:"sale_cost,omitempty"`
	SaleId   int32 `protobuf:"varint,19,opt,name=sale_id,json=saleId" json:"sale_id,omitempty"`
	// Reason for a move failure
	MoveFailure string `protobuf:"bytes,20,opt,name=move_failure,json=moveFailure" json:"move_failure,omitempty"`
}
...
type UpdateRecordRequest struct {
	...
	NoSell    bool    `protobuf:"varint,3,opt,name=no_sell,json=noSell" json:"no_sell,omitempty"`
}
...
var fileDescriptor0 = []byte{
	...
	,
}
