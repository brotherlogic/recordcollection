...
var file_recordcollection_proto_rawDesc = []byte{
	...
	0x10, 0x03, 0x32, 0x80, 0x08, 0x0a, 0x17, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x43, 0x6f, 0x6c,
...
var file_recordcollection_proto_msgTypes = make([]protoimpl.MessageInfo, 46)
var file_recordcollection_proto_goTypes = []interface{}{
	...
	(*ClientUpdateRequest)(nil),         // 41: recordcollection.ClientUpdateRequest
	(*ClientUpdateResponse)(nil),        // 42: recordcollection.ClientUpdateResponse
	nil,                                 // 43: recordcollection.RecordCollection.InstanceToFolderEntry
	nil,                                 // 44: recordcollection.RecordCollection.InstanceToUpdateEntry
	nil,                                 // 45: recordcollection.RecordCollection.InstanceToUpdateInEntry
	nil,                                 // 46: recordcollection.RecordCollection.InstanceToCategoryEntry
	nil,                                 // 47: recordcollection.RecordCollection.InstanceToMasterEntry
	nil,                                 // 48: recordcollection.RecordCollection.InstanceToIdEntry
	nil,                                 // 49: recordcollection.RecordCollection.InstanceToRecacheEntry
	nil,                                 // 50: recordcollection.RecordCollection.InstanceToLastSalePriceUpdateEntry
	nil,                                 // 51: recordcollection.GetOrderResponse.ListingToPriceEntry
	(*godiscogs.Release)(nil),           // 52: godiscogs.Release
	(godiscogs.SaleState)(0),            // 53: godiscogs.SaleState
}
var file_recordcollection_proto_depIdxs = []int32{
	...
	52, // 3: recordcollection.RecordCollection.wants:type_name -> godiscogs.Release
	12, // 4: recordcollection.RecordCollection.new_wants:type_name -> recordcollection.Want
	43, // 5: recordcollection.RecordCollection.instance_to_folder:type_name -> recordcollection.RecordCollection.InstanceToFolderEntry
	44, // 6: recordcollection.RecordCollection.instance_to_update:type_name -> recordcollection.RecordCollection.InstanceToUpdateEntry
	45, // 7: recordcollection.RecordCollection.instance_to_update_in:type_name -> recordcollection.RecordCollection.InstanceToUpdateInEntry
	46, // 8: recordcollection.RecordCollection.instance_to_category:type_name -> recordcollection.RecordCollection.InstanceToCategoryEntry
	47, // 9: recordcollection.RecordCollection.instance_to_master:type_name -> recordcollection.RecordCollection.InstanceToMasterEntry
	48, // 10: recordcollection.RecordCollection.instance_to_id:type_name -> recordcollection.RecordCollection.InstanceToIdEntry
	49, // 11: recordcollection.RecordCollection.instance_to_recache:type_name -> recordcollection.RecordCollection.InstanceToRecacheEntry
	50, // 12: recordcollection.RecordCollection.instance_to_last_sale_price_update:type_name -> recordcollection.RecordCollection.InstanceToLastSalePriceUpdateEntry
	11, // 13: recordcollection.AllRecords.records:type_name -> recordcollection.Record
	52, // 14: recordcollection.Record.release:type_name -> godiscogs.Release
	...
	53, // 18: recordcollection.ReleaseMetadata.sale_state:type_name -> godiscogs.SaleState
	...
	51, // 37: recordcollection.GetOrderResponse.listing_to_price:type_name -> recordcollection.GetOrderResponse.ListingToPriceEntry
	...
	41, // 50: recordcollection.ClientUpdateService.ClientUpdate:input_type -> recordcollection.ClientUpdateRequest
	...
	40, // 61: recordcollection.RecordCollectionService.CommitRecord:output_type -> recordcollection.CommitRecordResponse
	42, // 62: recordcollection.ClientUpdateService.ClientUpdate:output_type -> recordcollection.ClientUpdateResponse
