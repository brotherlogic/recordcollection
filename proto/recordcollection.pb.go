...
type RecordCollectionServiceClient interface {
	...
	GetRecordStream(ctx context.Context, in *GetRecordsRequest, opts ...grpc.CallOption) (RecordCollectionService_GetRecordStreamClient, error)
...
func (c *recordCollectionServiceClient) GetRecordStream(ctx context.Context, in *GetRecordsRequest, opts ...grpc.CallOption) (RecordCollectionService_GetRecordStreamClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_RecordCollectionService_serviceDesc.Streams[0], c.cc, "/recordcollection.RecordCollectionService/GetRecordStream", opts...)
	if err != nil {
		return nil, err
	}
	x := &recordCollectionServiceGetRecordStreamClient{stream}
...
type RecordCollectionService_GetRecordStreamClient interface {
	Recv() (*Record, error)
	grpc.ClientStream
}

type recordCollectionServiceGetRecordStreamClient struct {
	grpc.ClientStream
}

func (x *recordCollectionServiceGetRecordStreamClient) Recv() (*Record, error) {
	m := new(Record)
...
type RecordCollectionServiceServer interface {
	...
	GetRecordStream(*GetRecordsRequest, RecordCollectionService_GetRecordStreamServer) error
...
func _RecordCollectionService_GetRecordStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	m := new(GetRecordsRequest)
	if err := stream.RecvMsg(m); err != nil {
		return err
	}
	return srv.(RecordCollectionServiceServer).GetRecordStream(m, &recordCollectionServiceGetRecordStreamServer{stream})
}

type RecordCollectionService_GetRecordStreamServer interface {
	Send(*Record) error
	grpc.ServerStream
}

type recordCollectionServiceGetRecordStreamServer struct {
	grpc.ServerStream
}

func (x *recordCollectionServiceGetRecordStreamServer) Send(m *Record) error {
	...
	Streams: []grpc.StreamDesc{
		{
			...
			Handler:       _RecordCollectionService_GetRecordStream_Handler,
			ServerStreams: true,
		},
	},
...
var fileDescriptor0 = []byte{
	...
	,
}
