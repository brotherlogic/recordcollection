...
var file_recordcollection_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x35, 0x0a, 0x13, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x55, 0x70,
	...
	0x5f, 0x47, 0x4f, 0x4f, 0x44, 0x10, 0x03, 0x32, 0xef, 0x05, 0x0a, 0x17, 0x52, 0x65, 0x63, 0x6f,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x32, 0x76, 0x0a, 0x13, 0x43, 0x6c, 0x69,
	0x65, 0x6e, 0x74, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x12, 0x5f, 0x0a, 0x0c, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	0x12, 0x25, 0x2e, 0x72, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74,
	0x69, 0x6f, 0x6e, 0x2e, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	...
	0x6f, 0x72, 0x64, 0x63, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2f, 0x70, 0x72,
...
var file_recordcollection_proto_msgTypes = make([]protoimpl.MessageInfo, 39)
var file_recordcollection_proto_goTypes = []interface{}{
	...
	nil, // 37: recordcollection.RecordCollection.InstanceToUpdateInEntry
	nil, // 38: recordcollection.RecordCollection.InstanceToCategoryEntry
	nil, // 39: recordcollection.RecordCollection.InstanceToMasterEntry
	nil, // 40: recordcollection.RecordCollection.InstanceToIdEntry
	nil, // 41: recordcollection.RecordCollection.InstanceToRecacheEntry
	nil, // 42: recordcollection.RecordCollection.InstanceToLastSalePriceUpdateEntry
	(*godiscogs.Release)(nil), // 43: godiscogs.Release
	(godiscogs.SaleState)(0),  // 44: godiscogs.SaleState
}
var file_recordcollection_proto_depIdxs = []int32{
	...
	43, // 3: recordcollection.RecordCollection.wants:type_name -> godiscogs.Release
	...
	37, // 7: recordcollection.RecordCollection.instance_to_update_in:type_name -> recordcollection.RecordCollection.InstanceToUpdateInEntry
	38, // 8: recordcollection.RecordCollection.instance_to_category:type_name -> recordcollection.RecordCollection.InstanceToCategoryEntry
	39, // 9: recordcollection.RecordCollection.instance_to_master:type_name -> recordcollection.RecordCollection.InstanceToMasterEntry
	40, // 10: recordcollection.RecordCollection.instance_to_id:type_name -> recordcollection.RecordCollection.InstanceToIdEntry
	41, // 11: recordcollection.RecordCollection.instance_to_recache:type_name -> recordcollection.RecordCollection.InstanceToRecacheEntry
	42, // 12: recordcollection.RecordCollection.instance_to_last_sale_price_update:type_name -> recordcollection.RecordCollection.InstanceToLastSalePriceUpdateEntry
	8,  // 13: recordcollection.AllRecords.records:type_name -> recordcollection.Record
	43, // 14: recordcollection.Record.release:type_name -> godiscogs.Release
	12, // 15: recordcollection.Record.metadata:type_name -> recordcollection.ReleaseMetadata
	43, // 16: recordcollection.Want.release:type_name -> godiscogs.Release
	...
	44, // 20: recordcollection.ReleaseMetadata.sale_state:type_name -> godiscogs.SaleState
	...
	1,  // 35: recordcollection.RecordCollection.InstanceToCategoryEntry.value:type_name -> recordcollection.ReleaseMetadata.Category
	15, // 36: recordcollection.RecordCollectionService.GetWants:input_type -> recordcollection.GetWantsRequest
	17, // 37: recordcollection.RecordCollectionService.UpdateRecord:input_type -> recordcollection.UpdateRecordRequest
	19, // 38: recordcollection.RecordCollectionService.UpdateWant:input_type -> recordcollection.UpdateWantRequest
	21, // 39: recordcollection.RecordCollectionService.AddRecord:input_type -> recordcollection.AddRecordRequest
	25, // 40: recordcollection.RecordCollectionService.DeleteRecord:input_type -> recordcollection.DeleteRecordRequest
	27, // 41: recordcollection.RecordCollectionService.QueryRecords:input_type -> recordcollection.QueryRecordsRequest
	29, // 42: recordcollection.RecordCollectionService.GetRecord:input_type -> recordcollection.GetRecordRequest
	31, // 43: recordcollection.RecordCollectionService.Trigger:input_type -> recordcollection.TriggerRequest
	33, // 44: recordcollection.ClientUpdateService.ClientUpdate:input_type -> recordcollection.ClientUpdateRequest
	16, // 45: recordcollection.RecordCollectionService.GetWants:output_type -> recordcollection.GetWantsResponse
	18, // 46: recordcollection.RecordCollectionService.UpdateRecord:output_type -> recordcollection.UpdateRecordsResponse
	20, // 47: recordcollection.RecordCollectionService.UpdateWant:output_type -> recordcollection.UpdateWantResponse
	22, // 48: recordcollection.RecordCollectionService.AddRecord:output_type -> recordcollection.AddRecordResponse
	26, // 49: recordcollection.RecordCollectionService.DeleteRecord:output_type -> recordcollection.DeleteRecordResponse
	28, // 50: recordcollection.RecordCollectionService.QueryRecords:output_type -> recordcollection.QueryRecordsResponse
	30, // 51: recordcollection.RecordCollectionService.GetRecord:output_type -> recordcollection.GetRecordResponse
	32, // 52: recordcollection.RecordCollectionService.Trigger:output_type -> recordcollection.TriggerResponse
	34, // 53: recordcollection.ClientUpdateService.ClientUpdate:output_type -> recordcollection.ClientUpdateResponse
