...
func TestGetRecordsMoveStripped(t *testing.T) {
	...
	r, err := s.GetRecords(context.Background(), &pb.GetRecordsRequest{MoveStrip: true, Filter: &pb.Record{}})
