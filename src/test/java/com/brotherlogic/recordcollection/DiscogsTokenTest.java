...
public class DiscogsTokenTest extends BaseTest {
  ...
  @Test
  public void testBuildUserBackendWithFile() {
    EnvironmentVariable.set("discogsbackend","file");
    DiscogsService serv = Mockito.mock(DiscogsService.class);
    DiscogsToken token = new DiscogsToken("TestKey", "TestSecret", serv);
    Assert.assertNotNull(token.getUserBackend(new RequestBuilder() {
        public OAuthRequest buildRequest(Verb v, String url) {
  ...
  @Test
  public void testBuildCollectionBackendWithFile() {
    EnvironmentVariable.set("discogsbackend","file");
    DiscogsService serv = Mockito.mock(DiscogsService.class);
    DiscogsToken token = new DiscogsToken("TestKey", "TestSecret", serv);
    Assert.assertNotNull(token.getCollectionBackend(new RequestBuilder() {
