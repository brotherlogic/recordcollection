 ...
 * Extended in order to insert the discogs headers
 *
 * @author Pablo Fernandez
 * @author Simon Tucker
 */
public class DiscogsService implements OAuthService
{
     ...
     */
    public DiscogsService(DefaultApi10a api, OAuthConfig config)
    {
        this.api = api;
        this.config = config;
    }
    ...
    public Token getRequestToken(RequestTuner tuner)
    {
        ...
        if (localCallback.length() > 0)
            request.addOAuthParameter(OAuthConstants.CALLBACK, localCallback);
        else
        ...
        //brotherlogic: Adding headers here
    ...
    public void setCallback(String callbackURI) {
        localCallback = callbackURI;
    }
